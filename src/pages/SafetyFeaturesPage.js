  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <h1 className="text-3xl font-bold mb-4">Safety Features</h1>
        <p className="text-gray-600 mb-6">
          Your current plan: <span className={`font-semibold ${
            hasAccess('elite') ? 'text-purple-600' :
            hasAccess('premium') ? 'text-indigo-600' :
            'text-green-600'
          }`}>
            {formatTierName(hasAccess('elite') ? 'elite' : hasAccess('premium') ? 'premium' : 'basic')}
          </span>
        </p>
              ...
              <div className="bg-white rounded-lg shadow p-6 border border-gray-100">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Get access to all safety features and more with our Premium plan.
                    </p>
                    <Link
